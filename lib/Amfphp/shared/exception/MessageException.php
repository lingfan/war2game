...
class MessageException {
	 ...
	 */
	public function MessageException($code, $description, $file, $line, $detailCode = 'AMFPHP_RUNTIME_ERROR') {
	 ...
	 * @see AMFBody
	 */
	static public function throwException(&$body, $exception) {
	...
	static public function getFriendlyError($err) {
		$errortype = array(
			1 => "Error",
			2 => "Warning",
			4 => "Parsing Error",
